...
New BTCV Block Rewards.
The original BTCV VBR Rewards system was too loose with the block rewards. This caused a
tremenous amount of BTCV to flood the market. Lessons learned from the original BTCV
...
Bitcoin by allowing miners to get greedy and try for the 800 BTCV block reward.

The algorithm is still 51% attack deterrent since it pays miners with more hashpower
considerably more than a low hash miner.
----------------------
