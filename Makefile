...
ACLOCAL = ${SHELL} /Users/software/bitcoinV/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /Users/software/bitcoinV/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/software/bitcoinV/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/software/bitcoinV/build-aux/missing automake-1.16
...
BOOST_LIBS = -L/usr/local/lib -lboost_system -lboost_filesystem -lboost_thread-mt -lboost_chrono-mt
...
COPYRIGHT_HOLDERS_SUBSTITUTION = BitcoinV Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
CPPFILT = /usr/bin/c++filt
CPPFLAGS =  -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -I/usr/local/opt/berkeley-db@4/include -DMAC_OSX
CRYPTO_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2q/include
CRYPTO_LIBS = -L/usr/local/Cellar/openssl/1.0.2q/lib -lcrypto
CXX = g++ -std=c++11
CXXCPP = g++ -std=c++11 -E
...
MAINT = 
MAKEINFO = ${SHELL} /Users/software/bitcoinV/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = BitcoinV Core 1.1.1
...
PORT = 
PROTOBUF_CFLAGS = -pthread -I/usr/local/Cellar/protobuf/3.6.1.3/include
PROTOBUF_LIBS = -L/usr/local/Cellar/protobuf/3.6.1.3/lib -lprotobuf -pthread
...
SSL_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2q/include
SSL_LIBS = -L/usr/local/Cellar/openssl/1.0.2q/lib -lssl
STRIP = /usr/bin/strip
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /Users/software/bitcoinV
abs_srcdir = /Users/software/bitcoinV
abs_top_builddir = /Users/software/bitcoinV
abs_top_srcdir = /Users/software/bitcoinV
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/software/bitcoinV/build-aux/install-sh
